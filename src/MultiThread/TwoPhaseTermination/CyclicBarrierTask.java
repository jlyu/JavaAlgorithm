...
public class CyclicBarrierTask implements Runnable {
    ...
    public CyclicBarrierTask(CyclicBarrier phaseBarrier, CountDownLatch doneLatch, int context) {
    ...
    protected void doPhase(int phase) {
        ...
        System.out.println(name + ":MyTask:StaRT:context = " + context + ", phase = " + phase);

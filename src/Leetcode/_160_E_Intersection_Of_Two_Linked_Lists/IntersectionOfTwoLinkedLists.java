package Leetcode._160_E_Intersection_Of_Two_Linked_Lists;
...
From the head of A, it reads as [0,9,1,2,4]. From the head of B, it reads as [3,2,4]. There are 3 nodes
...
public class IntersectionOfTwoLinkedLists {
    ...
    public ListNode getIntersectionNode(ListNode headA, ListNode headB) {
        ...
        ListNode nodeB = (lenA >= lenB) ? headB : headA;
    ...
    public void unittest1() {
        ...
        ListNode headB = createList(new int[] {5,0,1,8,4,5});
